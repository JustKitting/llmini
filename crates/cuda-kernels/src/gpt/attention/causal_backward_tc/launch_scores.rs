...
use super::matmul::{
    AttentionTcMatmulContext, run_tc_matmul, run_tc_matmul_lower_ds, run_tc_matmul_lower_ds_sparse,
};
...
pub(super) fn run_ds_scores_sparse(
    ctx: &AttentionTcMatmulContext<'_>,
    d_out: &cuda_core::DeviceBuffer<u16>,
    v: &cuda_core::DeviceBuffer<u16>,
    probs: &cuda_core::DeviceBuffer<u16>,
    softmax_d: &cuda_core::DeviceBuffer<f32>,
    tile_scales: &cuda_core::DeviceBuffer<f32>,
    ds: &mut cuda_core::DeviceBuffer<u16>,
) -> Result<(), DriverError> {
    run_tc_matmul_lower_ds_sparse(
        ctx.stream,
        ctx.tc_module,
        d_out,
        v,
