...
use crate::f16_tc_matmul::{
    ...
    F16TcMatmulHalfRhsWindowArgs, F16TcMatmulModule,
};
...
#[expect(clippy::too_many_arguments, reason = "CUDA ABI uses explicit buffers")]
pub(super) fn run_tc_matmul_lower_ds_sparse(
    stream: &CudaStream,
    tc_module: &F16TcMatmulModule,
    a: &DeviceBuffer<u16>,
    b_t: &DeviceBuffer<u16>,
    ...
    tc_module.batched_matmul_half_input_windowed_lower_ds_sparse(
...
#[expect(clippy::too_many_arguments, reason = "CUDA ABI uses explicit buffers")]
pub(super) fn run_tc_matmul_rhs_sparse(
    stream: &CudaStream,
    tc_module: &F16TcMatmulModule,
    a: &DeviceBuffer<u16>,
    rhs: &DeviceBuffer<u16>,
    ...
    tc_module.batched_matmul_half_rhs_windowed_lower_a_sparse(F16TcMatmulHalfRhsSparseWindowArgs {
        stream,
        a,
        rhs,
        tile_scales,
...
#[expect(clippy::too_many_arguments, reason = "CUDA ABI uses explicit buffers")]
pub(super) fn run_tc_matmul_a_transposed_rhs_sparse(
    stream: &CudaStream,
    tc_module: &F16TcMatmulModule,
    a: &DeviceBuffer<u16>,
    rhs: &DeviceBuffer<u16>,
    ...
    tc_module.batched_matmul_half_a_transposed_rhs_windowed_lower_a_sparse(
...
#[expect(clippy::too_many_arguments, reason = "CUDA ABI uses explicit buffers")]
pub(super) fn run_tc_matmul_a_transposed_rhs_sparse_scaled(
    stream: &CudaStream,
    tc_module: &F16TcMatmulModule,
    a: &DeviceBuffer<u16>,
    rhs: &DeviceBuffer<u16>,
    ...
    tc_module.batched_matmul_half_a_transposed_rhs_windowed_lower_a_sparse_scaled(
        F16TcMatmulHalfRhsSparseWindowArgs {
            stream,
            a,
            rhs,
