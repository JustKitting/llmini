...
pub use config::{
    ...
    GPT2_SEQ_LEN, GPT2_TOKEN_ROWS, GPT2_V_OFFSET, GPT2_VOCAB_SIZE, Gpt2Config, KDA_CHUNK_SIZE,
    KDA_DECAY_SCALE, KIMI_FULL_ATTENTION_PERIOD, NEXTLAT_HIDDEN, NEXTLAT_INPUT, layer_norm_scale,
    uses_block_topk_mlp, uses_full_attention,
};
pub use config::{
